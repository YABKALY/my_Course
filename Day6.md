...
* so  It will install by the command  pip install term
* If the package is already installed: you will continue
...
* New version
### Old version
go get github.com . . . .etc
## New version 
1. Downloading the package go install github.com . . . . etc
2. Moving the file to /usr/bin( the default download place is /home/yoni/go/bin 
